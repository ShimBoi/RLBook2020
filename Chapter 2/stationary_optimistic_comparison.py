...
policies = {
    "Greedy (ε=0)": IncrementalPolicy(epsilon=0.0, alpha=0.1, k=k, initial=5), # optimistic initial value of 5
    "ε = 0.1":      IncrementalPolicy(epsilon=0.1, alpha=0.1, k=k, initial=0),
}
